...
class Bootleg(object):
    ...
    def disambiguate_mentions(self, config_args, file_name):
        ...
        with open(f'{self.args.bootleg_output_dir}/{file_name}_bootleg/eval/{self.ckpt_name}/bootleg_labels.jsonl',
                  'r') as fin:
        ...
        if self.args.bootleg_load_prepped_data:
            with open(f'{self.args.bootleg_output_dir}/{file_name}_bootleg/eval/{self.ckpt_name}/bootleg_embs.npy',
                      'rb') as fin:
